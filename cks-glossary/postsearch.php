...
<html>
    ...
    <body>
        ...
        <div class='card about-us'>
            ...
            <h5>ABOUT ENGLISH TO KAPAMPANGAN GLOSSARY</h5>
            <p>English to Kapampangan Glossary is an advocacy project of Center for Kapampangan Studies to promote our rich kapampangan literacy. The project was developed by 4th year Web Development
                students from Holy Angel University in completion of their intership.</p>
            <hr>
            <div class='the-team'>
                <h5>English to Kapampangan Glossary Developers</h5>
                <div class='name-row'>
                    <div class="row">
...
if (!empty($_POST['search'])) {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $html .= '<div class="card my-4" id="card-out">';
        $html .= '<svg xmlns="http://www.w3.org/2000/svg" width="3vw" height="3vw" fill="currentColor" class="bi bi-exclamation-circle-fill" viewBox="0 0 16 16">
